	...
	<view class="container">
		<view class="content">
			<view class="list">
				...
				<view class="bigaline">
					<view class="left">退票原因<text  class="requisite">*</text>：</view>
					<view class="right"><textarea  class="textarea" placeholder="请输入退票原因" v-model="return_reason"></textarea></view>
				</view>
				<view class="btn">
					<button class="" type="primary" @click="returnbtn">确认退票</button>
				</view>
			</view>
		</view>
	</view>	
	...
	export default{
		...
		methods:{
			returnbtn(){
				...
				$.post('/erp/invoice/return',data).then(res=>{
					if(res.code==0){
						uni.showToast({
							title:res.message
						})
